-- =====================================================
--      NON-CLUSTERED INDEXES FOR ELECTION MANAGEMENT SYSTEM
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: election_commission
-- =====================================================
...
CREATE INDEX idx_polling_stations_station_code ON polling_stations(station_code);
...
CREATE INDEX idx_candidates_election_party ON candidates(election_id, party_id);
...
-- =====================================================
-- INDEXES FOR TABLE: election_agents
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: polling_officers
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: voter_verification
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: election_phases
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: station_resources
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: ballot_papers
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: voter_turnout
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: observer_reports
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: candidate_manifesto
-- =====================================================
...
CREATE INDEX idx_candidate_manifesto_manifesto_ref ON candidate_manifesto(manifesto_ref);
...
-- =====================================================
-- INDEXES FOR TABLE: party_alliances
-- =====================================================
...
-- =====================================================
-- INDEXES FOR TABLE: election_budgets
-- =====================================================
