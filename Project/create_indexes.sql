-- =====================================================
--      ELECTION MANAGEMENT SYSTEM - Database Indexes
-- =====================================================

USE election_management_system;

-- 1. ADMINS
CREATE INDEX idx_admins_profile ON admins(profile);
...
CREATE INDEX idx_polling_stations_is_enabled ON polling_stations(is_enabled);
...
CREATE INDEX idx_polling_stations_deleted_at ON polling_stations(deleted_at);
...
CREATE INDEX idx_political_parties_party_symbol ON political_parties(party_symbol);
...
CREATE INDEX idx_candidate_documents_document_path ON candidate_documents(document_path);
...
CREATE INDEX idx_complaints_evidence_path ON complaints(evidence_path);
...
CREATE INDEX idx_voter_verification_location_coordinates ON voter_verification(location_coordinates);
...
CREATE INDEX idx_votes_device_info ON votes(device_info);
...
CREATE INDEX idx_media_coverage_media_url ON media_coverage(media_url);
